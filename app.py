...
feature_2 = st.number_input("industry")
feature_3 = st.number_input("airport")
feature_4= st.number_input("air_pollution")
feature_5 = st.number_input("avg_rooms")
feature_6 = st.number_input("age")
feature_7 = st.number_input("dis")
feature_8 = st.number_input("hw_acc")
feature_9 = st.number_input("tax")
feature_10 = st.number_input("education")
feature_11 = st.number_input("lstat")
